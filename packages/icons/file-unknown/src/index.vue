<template>
  <svg t="1786358721812" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="21852" width="200" height="200">
    <path
    ...
    <path
      ...
      p-id="21854"></path>
    <path d="M512 744m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" p-id="21855"></path>
  </svg>
</template>
<script>
...
export default {
  name: genericIconName('FileUnknown')
}
</script>
