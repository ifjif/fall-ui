<template>
  <svg t="1786362615070" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="26008" width="200" height="200">
    <path d="M552 472m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" p-id="26009"></path>
    <path
...
export default {
  name: genericIconName('Experiment')
}
</script>
