<template>
  <svg t="1786353149613" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <path
      ...
      p-id="19999"></path>
    <path d="M512 784m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" p-id="20000"></path>
  </svg>
</template>
<script>
