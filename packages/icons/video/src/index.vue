<template>
  <svg t="1786366447129" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="33840" width="200" height="200">
    <path
      ...
      p-id="33841"></path>
    <path d="M208 360h112c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H208c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" p-id="33842">
    </path>
  </svg>
</template>
<script>
