<template>
  <svg t="1786449141062" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="22556" width="200" height="200">
    <path
      ...
      p-id="22557"></path>
    <path d="M512 556m-96 0a96 96 0 1 0 192 0 96 96 0 1 0-192 0Z" p-id="22558"></path>
  </svg>
</template>
<script>
...
export default {
  name: genericIconName('CameraFill')
}
</script>
