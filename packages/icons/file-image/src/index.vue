<template>
  <svg t="1786359236572" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="22315" width="200" height="200">
    <path
      ...
      p-id="22316"></path>
    <path d="M400 442m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" p-id="22317"></path>
    <path
...
export default {
  name: genericIconName('FileImage')
}
</script>
