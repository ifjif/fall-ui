<template>
  <svg t="1786357808663" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="20921" width="200" height="200">
    <path
      ...
      p-id="20922"></path>
    <path d="M672 812m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" p-id="20923"></path>
    <path d="M652 748h40c4.4 0 8-3.6 8-8V628c0-4.4-3.6-8-8-8h-40c-4.4 0-8 3.6-8 8v112c0 4.4 3.6 8 8 8z" p-id="20924">
    </path>
    <path
...
export default {
  name: genericIconName('FileException')
}
</script>
