<template>
  <svg t="1786352444989" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="19535" width="200" height="200">
    <path
    ...
    <path
      ...
      p-id="19537"></path>
    <path d="M680 788m-40 0a40 40 0 1 0 80 0 40 40 0 1 0-80 0Z" p-id="19538"></path>
  </svg>
</template>
<script>
