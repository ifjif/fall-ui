<template>
  <svg t="1786339328149" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="10763" width="200" height="200">
    <path
      ...
      p-id="10764"></path>
    <path d="M480 560h64c4.4 0 8-3.6 8-8V88c0-4.4-3.6-8-8-8h-64c-4.4 0-8 3.6-8 8v464c0 4.4 3.6 8 8 8z" p-id="10765">
    </path>
  </svg>
</template>
<script>
