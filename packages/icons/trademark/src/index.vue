<template>
  <svg t="1786286650925" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="15768" width="200" height="200">
    <path
...
export default {
  name: genericIconName('Trademark')
}
</script>
