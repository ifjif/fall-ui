<template>
  <svg t="1786359394807" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="22470" width="200" height="200">
    <path
...
export default {
  name: genericIconName('FileMarkdown')
}
</script>
