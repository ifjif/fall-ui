<template>
  <svg t="1786366167666" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="33069" width="200" height="200">
    <path
      ...
      p-id="33070"></path>
    <path d="M456 748m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" p-id="33071"></path>
    <path d="M456 570m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" p-id="33072"></path>
    <path
...
export default {
  name: genericIconName('CloudServer')
}
</script>
