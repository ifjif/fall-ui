<template>
  <svg t="1786284715713" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="13604" width="200" height="200">
    <path
    ...
    <path
      ...
      p-id="13606"></path>
    <path d="M464.4 422L422 464.4l25.5 25.6 86.9 86.8 26.2 26.2 42.4-42.4-26.2-26.2-86.8-86.9z" p-id="13607"></path>
  </svg>
</template>
<script>
