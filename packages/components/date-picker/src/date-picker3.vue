<template>
  <div ref="datePickerRef" class="ep-date-picker">
    ...
    <div v-show="showPicker" class="ep-picker-panel">
      <!-- 快捷选项 -->
      <div v-if="false" class="ep-picker-panel__sidebar">
        <button class="ep-button--text" @click="handleShortcutClick(shortCut)" v-for="shortCut in shortCuts"
          :key="shortCut.text">
          {{ shortCut.text }}
        </button>
      </div>
      ...
      <div class="ep-picker-panel__body">
        ...
        <div class="ep-picker-panel__header">
          <button type="button" @click="prevMonth" class="ep-picker-panel__icon-btn">
            <TogglePrevIcon />
          </button>
          <span class="ep-picker-panel__title">{{ currentMonthName }} {{ currentYear }}</span>
          <button type="button" @click="nextMonth" class="ep-picker-panel__icon-btn">
            <ToggleNextIcon />
          </button>
        </div>
        <!-- 星期标题 -->
